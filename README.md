...
## 项目状态
此列表从 **2026-08-17 01:06** 开始记录。
| 时间       | 主要修改内容                 | 修改内容详细信息                                                                 | 状态       |
|------------|------------------------------|----------------------------------------------------------------------------------|------------|
| 2026-08-17 01:06| 重构了项目部分内容，例如Json和半自动上传等         | 为项目添加了 `MainProjectCatalogue` 文件夹，用于将 Github 半自动化使用的文件和工具上传到这个文件夹进行分类，便于进行更清晰的 Minecraft 改造           | ✅ 已合并   |
| 2026-08-17 01:12| 在 Readme 中添加了项目状态列表         | 无           | ✅ 已合并   |

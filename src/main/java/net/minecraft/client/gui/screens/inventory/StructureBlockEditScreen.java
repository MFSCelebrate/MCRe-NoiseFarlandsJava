...
public class StructureBlockEditScreen extends Screen {
    ...
    protected void init() {
        ...
        this.posXEdit.setValue(String.valueOf(minPos.getX()));
        ...
        this.posYEdit.setValue(String.valueOf(minPos.getY()));
        ...
        this.posZEdit.setValue(String.valueOf(minPos.getZ()));
        ...
        this.sizeXEdit.setValue(String.valueOf(maxPos.getX()));
        ...
        this.sizeYEdit.setValue(String.valueOf(maxPos.getY()));
        ...
        this.sizeZEdit.setValue(String.valueOf(maxPos.getZ()));

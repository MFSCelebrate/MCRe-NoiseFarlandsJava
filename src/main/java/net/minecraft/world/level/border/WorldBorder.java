...
public class WorldBorder extends SavedData {
    public static final double MAX_SIZE = Double.POSITIVE_INFINITY;
    public static final double MAX_CENTER_COORDINATE = Double.POSITIVE_INFINITY;
    ...
    private long absoluteMaxSize = Long.MAX_VALUE;
    private WorldBorder.BorderExtent extent = new WorldBorder.StaticBorderExtent(Double.POSITIVE_INFINITY);

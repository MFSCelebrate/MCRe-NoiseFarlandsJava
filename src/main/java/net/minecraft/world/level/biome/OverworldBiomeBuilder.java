...
public final class OverworldBiomeBuilder {
   ...
   public List<SpawnTargetPoint> spawnTarget(
      final Holder<DensityFunction> temperature,
      final Holder<DensityFunction> vegetation,
      final Holder<DensityFunction> continents,
      final Holder<DensityFunction> erosion,
      final Holder<DensityFunction> weirdness
   ) {

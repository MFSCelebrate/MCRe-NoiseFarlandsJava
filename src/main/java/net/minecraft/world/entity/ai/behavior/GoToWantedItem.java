...
public class GoToWantedItem {
    public static BehaviorControl<
                    LivingEntity> create(final float speedModifier, final boolean interruptOngoingWalk, final int maxDistToWalk) {
    ...
    public static <E extends LivingEntity> BehaviorControl<E> create(
            final Predicate<
                    E> predicate, final float speedModifier, final boolean interruptOngoingWalk, final int maxDistToWalk) {
                ...
                i -> {
                    BehaviorBuilder<
                            ...
                            ? extends
                                    MemoryAccessor<
                                            ? extends K1,
                                            WalkTarget>> walkCondition = interruptOngoingWalk

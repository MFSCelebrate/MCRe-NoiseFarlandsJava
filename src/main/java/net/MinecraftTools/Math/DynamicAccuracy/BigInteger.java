    ...
    public BigInteger modPow(BigInteger exponent, BigInteger m) {
        ...
        if (m.testBit(0)) {
            ...
            if (m.mag.length < MAX_MAG_LENGTH / 2) {
                ...
                MutableBigInteger t1 = MutableBigInteger.borrowTemp();
                MutableBigInteger work = t1.shallowCopy(a1.multiply(m2));
                work.multiply(MutableBigInteger.borrowTempB().shallowCopy(y1), t1);

                MutableBigInteger t2 = MutableBigInteger.borrowTempC();
                MutableBigInteger work2 = MutableBigInteger.borrowTempD().shallowCopy(a2.multiply(m1));
                work2.multiply(MutableBigInteger.borrowTempE().shallowCopy(y2), t2);
